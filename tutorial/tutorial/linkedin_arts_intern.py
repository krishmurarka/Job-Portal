...
class linkedin_arts_intern(scrapy.Spider):

    name = 'linkedin_arts_intern'
    start_urls = ['https://in.linkedin.com/jobs/search?keywords=Graphic%20Arts&location=India&locationId=&geoId=102713980&sortBy=R&f_TPR=&f_E=1&position=1&pageNum=0']
