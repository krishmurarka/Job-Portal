...
class internshala_com_fte(scrapy.Spider):

    name = 'internshala_com_fte'

    start_urls = ["https://internshala.com/fresher-jobs/accounts,chartered%20accountancy%20(ca),commerce,finance-jobs"]
