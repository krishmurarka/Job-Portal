...
class linkedin_arts_fte(scrapy.Spider):

    name = 'linkedin_arts_fte'
    start_urls = ['https://in.linkedin.com/jobs/search?keywords=Graphic%20Arts&location=India&locationId=&geoId=102713980&sortBy=R&f_TPR=&f_E=2&position=1&pageNum=0']
