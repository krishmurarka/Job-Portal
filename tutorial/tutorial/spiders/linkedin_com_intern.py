...
class linkedin_com_intern(scrapy.Spider):

    name = 'linkedin_com_intern'
    start_urls = ['https://in.linkedin.com/jobs/search?keywords=Commerce&location=India&locationId=&geoId=102713980&sortBy=R&f_TPR=&f_E=1&position=1&pageNum=0']
